...
?>
<style type="text/css">
#foundation_error { background: #ddd; font-size: 1em; font-family:sans-serif; text-align: left; color: #111; }
#foundation_error h1,
#foundation_error h2 { margin: 0; padding: 1em; font-size: 1em; font-weight: normal; background: #911; color: #fff; }
#foundation_error h1 a,
#foundation_error h2 a { color: #fff; }
#foundation_error h2 { background: #222; }
#foundation_error h3 { margin: 0; padding: 0.4em 0 0; font-size: 1em; font-weight: normal; }
#foundation_error p { margin: 0; padding: 0.2em 0; }
#foundation_error a { color: #1b323b; }
#foundation_error pre { overflow: auto; white-space: pre-wrap; }
#foundation_error table { width: 100%; display: block; margin: 0 0 0.4em; padding: 0; border-collapse: collapse; background: #fff; }
#foundation_error table td { border: solid 1px #ddd; text-align: left; vertical-align: top; padding: 0.4em; }
#foundation_error div.content { padding: 0.4em 1em 1em; overflow: hidden; }
#foundation_error pre.source { margin: 0 0 1em; padding: 0.4em; background: #fff; border: dotted 1px #b7c680; line-height: 1.2em; }
#foundation_error pre.source span.line { display: block; }
#foundation_error pre.source span.highlight { background: #f0eb96; }
#foundation_error pre.source span.line span.number { color: #666; }
#foundation_error ol.trace { display: block; margin: 0 0 0 2em; padding: 0; list-style: decimal; }
#foundation_error ol.trace li { margin: 0; padding: 0; }
