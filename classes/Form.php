 ...
 * safe using the HTML::chars method. This prevents against simple XSS attacks
 * that could otherwise be triggered by inserting HTML characters into form fields.
 *
 * @package    SuperFan
 * @category   Form
...
class Form
{
    ...
    public static function open( $action = NULL, array $attributes = NULL )
    {
        ...
        $attributes['accept-charset'] = Foundation::$charset;
