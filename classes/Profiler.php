...
class Profiler
{
	...
	public static function application()
	{
		...
		$stats = Foundation::cache('profiler_application_stats', NULL, 3600 * 24);
		...
		$time = microtime(TRUE) - FOUNDATION_START_TIME;

		// Get the total memory usage
		$memory = memory_get_usage() - FOUNDATION_START_MEMORY;
		...
		// Cache the new stats
		Foundation::cache('profiler_application_stats', $stats);
