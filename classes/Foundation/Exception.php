...
class Exception extends \Exception
{
     ...
     */
    public static $error_view = 'exception';
    ...
    public static function _handler( Exception $e )
    {
        ...
        catch( Exception $e )
        {
            ...
            header( 'Content-Type: text/plain; charset=' . Foundation::$charset, TRUE, 500 );
    ...
    public static function log( Exception $e, $level=Log::EMERGENCY )
    {
        if( is_object( Foundation::$log ) )
        {
            ...
            Foundation::$log->add($level, $error, NULL, array('exception' => $e));
    ...
    public static function response( Exception $e )
    {
        try
        {
            ...
            $response->headers( 'Content-Type', self::$error_view_content_type . '; charset=' . Foundation::$charset);
