...
class Minion_CLI
{
	...
	public static function color( $text, $foreground, $background = null )
	{
		...
		{
			throw new Foundation_Exception( 'Invalid CLI foreground color: ' . $foreground );
		}

		if( $background !== null && ! array_key_exists( $background, self::$background_colors ) )
		{
			throw new Foundation_Exception( 'Invalid CLI background color: ' . $background );
		}
