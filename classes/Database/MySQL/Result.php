...
namespace Forge\Database\MySQL;
...
class Result extends Database_Result
{
	...
	public function current()
	{
		...
		// mysql_fetch_object has been deprecated as of php 5.5!
		...
		else if( is_string( $this->_as_object ) )
		{
			 ...
			 * replaced by mysqli_fetch_object or PDOStatement::fetch(PDO::FETCH_OBJ) in Foundation 3.4.
			 */
