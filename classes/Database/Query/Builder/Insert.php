...
class Database_Query_Builder_Insert extends Database_Query_Builder
{
	...
	public function table( $table )
	{
		if( ! is_string( $table ) )
		{
			throw new Foundation_Exception( 'INSERT INTO syntax does not allow table aliasing' );
		}
	...
	public function values( array $values )
	{
		...
		{
			throw new Foundation_Exception( 'INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES' );
		}
	...
	public function select( Database_Query $query )
	{
		...
		{
			throw new Foundation_Exception( 'Only SELECT queries can be combined with INSERT queries' );
		}
