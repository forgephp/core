...
class Database_Query
{
	...
	public function __toString()
	{
		...
		{
			return Foundation_Exception::text( $e );
		}
	}
	...
	public function cached( $lifetime = NULL, $force = FALSE )
	{
		if( $lifetime === NULL )
		{
			...
			$lifetime = Foundation::$cache_life;
		}
	...
	public function execute( $db = NULL, $as_object = NULL, $object_params = NULL )
	{
		...
		if( $this->_lifetime !== NULL && $this->_type === Database::SELECT )
		{
			...
			if( ( $result = Foundation::cache($cache_key, NULL, $this->_lifetime) ) !== NULL && ! $this->_force_execute )
			{
		...
		if( isset( $cache_key ) && $this->_lifetime > 0 )
		{
			...
			Foundation::cache( $cache_key, $result->as_array(), $this->_lifetime );
		}
