...
class Response implements HTTP_Response
{
    ...
    public function status( $status=NULL )
    {
        ...
        else if( array_key_exists( $status, self::$messages ) )
        {
        ...
        if( ! empty( $options['delete'] ) )
        {
            ...
            catch( Exception $e )
            {
                ...
                if( is_object( Foundation::$log ) )
                {
                    ...
                    Foundation::$log->add( Log::ERROR, $error );
    ...
    public function render()
    {
        if( ! $this->_header->offsetExists( 'content-type' ) )
        {
            ...
            $this->_header['content-type'] = Foundation::$content_type.'; charset=' . Foundation::$charset;
        }
