...
class URL
{
    ...
    public static function base( $protocol = NULL, $index = FALSE )
    {
        ...
        if( $index === TRUE && ! empty( Foundation::$index_file ) )
        {
            // Add the index file to the URL
            $base_url .= Foundation::$index_file . '/';
        }
    ...
    public static function is_trusted_host( $host, array $trusted_hosts = NULL )
    {
        ...
        {
            $trusted_hosts = (array) Foundation::$config->load( 'url' )->get( 'trusted_hosts' );
        }
