 ...
 */
class Generator_Type_Fixture extends Generator_Type
{
	...
	public function load_from_file()
	{
		...
		if( ! is_file( $file ) )
		{
			throw new Generator_Exception( 'The fixture file could not be found at :path:', array( ':path' => $file ) );
		}
		...
		if( $matches && isset( $matches['expected'] ) )
		{
